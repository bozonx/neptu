...
<template>
  <div class="flex h-screen overflow-hidden bg-default text-default">
    <!-- Left Sidebar -->
    <div class="flex flex-col w-72 border-r border-default shrink-0 bg-default">
    ...
    <!-- Central Content -->
    <div class="flex-1 flex flex-col min-w-0 bg-default">
      <slot />
    </div>

    <!-- Right Sidebar -->
    <div class="flex flex-col w-64 border-l border-default shrink-0 bg-default">
      <FileSidebar />
    </div>
  </div>
</template>
