...
export function getEffectiveContentFolder(
  vault: Vault,
  config?: VaultConfig,
): string | undefined {
...
export function getEffectiveMediaDir(
  vault: Vault,
  config?: VaultConfig,
): MediaDirSettings {
...
export function getEffectiveAutoConvert(
  vault: Vault,
  config?: VaultConfig,
...
export function getEffectiveContentRoot(
  vault: Vault,
